...
var MobileMenu = function () {
    ...
    _createClass(MobileMenu, [{
        ...
        value: function events() {
            this.menuIcon.click(this.togglleMenu.bind(this));
        }
    }, {
        key: 'togglleMenu',
        value: function togglleMenu() {
...
var RevealOnScroll = function () {
    function RevealOnScroll(item, offsetItem) {
    ...
    _createClass(RevealOnScroll, [{
        ...
        key: 'createWaypoints',
        value: function createWaypoints(offsetItem) {
                ...
                new Waypoint({
                    ...
                    handler: function handler(direction) {
                        if (direction === 'down') {
                            ...
                            (0, _jquery2.default)(that.headerLinks).removeClass('is-current-link');
